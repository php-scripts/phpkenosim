...
*/
	...
	if(is_numeric($gametype+$bet+$games))
	{
		...
		{ 
			...
			$stat[] = array($m, implode(" ", $player), ($winning[$gametype][$m]*$bet));
			$payout += ($winning[$gametype][$m]*$bet);
		}
		...
		<center>
			...
			<?php 
					if(count($summery) > 0)
					{
						...
						echo '<table cellpadding="5" width="600px">
							  <tr>
			...
			<table cellpadding="5" width="600px">
				...
				<?php
					...
					foreach($stat as $data)
					{
						echo "<tr><td><b>".$g."</b></td>".
							 "<td>".$data[1]."</td>".
							 "<td>".$data[0]."</td><td bgcolor='#EAEAEA'".(($data[2] > 0) ? " style='font-weight: bold'" : "").">".$data[2]." €</td></tr>\r\n";
						$g++;
					}
